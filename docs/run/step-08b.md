...
1. `docs/what/architecture/fsm-design.md` — 전체 정독 (§1~6) — 이중 레벨 FSM 전체 + 전이 규칙 + 취약점 대응 (30분)
2. `docs/what/architecture/boot-shutdown-phase1.md` — §3 Crash Recovery 상세 — 복구 로직과 FSM 상태 연계 (15분)
