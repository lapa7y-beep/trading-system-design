...
inline stub (Step 0)를 MockBrokerAdapter로 교체. OrderExecutor가 submit_order()를 호출하여 체결 응답 수신.
...
1. `docs/what/specs/adapter-spec-phase1.md` — §5.1 MockBrokerAdapter — Mock 체결 시뮬레이션 명세 (10분)
2. `docs/what/architecture/path1-design.md` — §2.5 OrderExecutor — 주문 실행 로직 (10분)
3. `docs/what/specs/error-handling-phase1.md` — §3.5 OrderExecutor, §4.2 BrokerPort — 에러 처리 규칙 (5분)
4. `docs/what/specs/domain-types-phase1.md` — §3.5 Order (Order, Fill, OrderAck) — 타입 확인 (5분)
