...
1. `docs/what/specs/db-schema-phase1.sql` — 전체 (DDL) — 테이블 구조와 인덱스 (20분)
2. `docs/what/decisions/006-db-stack.md` — 전체 — PostgreSQL 선정 근거 (5분)
3. `docs/what/architecture/db-stack.md` — §1~2 확정 스택, 저장 원칙 — 저장 범위 확인 (10분)
4. `docs/what/specs/adapter-spec-phase1.md` — §6.1 PostgresStorageAdapter, §9.1 PostgresAuditAdapter — Adapter 구현 명세 (10분)
