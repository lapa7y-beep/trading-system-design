# ADR-011: Phase 1 범위·합격기준·구현순서 확정

> **목적**: Phase 1의 포함/제외 범위, 5개 합격 기준, 구현 순서를 확정한다. 모든 설계 문서의 최상위 기준.
> **층**: What
> **상태**: stable
> **확정일**: 2026-04-16
> **위치**: `docs/what/decisions/011-phase1-scope.md` (예정)
> **우선순위**: 이 문서와 다른 문서가 충돌하면 이 문서가 우선한다
> **구현 여정**: 이 문서의 범위와 합격 기준은 ADR-012에 정의된 17 Step으로 점진 구현됩니다. 각 Step의 실행 절차는 docs/run/step-NN.md 참조.
