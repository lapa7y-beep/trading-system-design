...
> **관련 ADR**: 010
> **Phase 1 주의**: 이 문서는 전체 비전(5 Path, 45 노드)을 기술한다. Phase 1 활성 범위는 **Path 1의 6노드만**이다. Phase 1 상세는 [`path1-design.md`](path1-design.md) 참조. 아래 수치(Section 7)는 전체 완성 시 목표이며 현재 활성 수치가 아니다.
...
```
StrategyRuntimePort (인터페이스) — 교체 가능한 추상화
