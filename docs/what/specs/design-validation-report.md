# Phase 1 설계 검증 보고서 (5차 교차검증·188항목)
...
**파일**: `docs/what/specs/test-strategy-phase1.md` line 84
```diff
...
**파일**: `docs/what/specs/test-strategy-phase1.md` §7
```diff
...
**수정 파일**: `docs/what/specs/adapter-spec-phase1.md` (v1.0 → v1.1)
...
- `docs/what/specs/adapter-spec-phase1.md` v1.1 → v1.2: CSVReplayAdapter unsubscribe 추가
...
- `docs/what/specs/config-schema-phase1.md` v1.0 → v1.1: backtest 섹션 추가 (initial_cash, slippage_bps, fee_rate, tax_rate)
- `docs/what/specs/project-structure-phase1.md` v1.0 → v1.1: enums.py 설명에 OrderType 추가
