...
1. `docs/decisions/011-phase1-scope.md` — §5 합격 기준 전체 — 5개 기준 최종 확인 (10분)
2. `docs/specs/test-strategy-phase1.md` — §5 합격 기준 테스트 전체 — 자동화 테스트 코드 (15분)
3. `docs/specs/error-handling-phase1.md` — §11 KIS 에러 코드 매핑 — 실제 KIS 에러 대응 확인 (10분)
4. `docs/specs/design-validation-report.md` — 전체 — 5차 검증 결과 최종 확인 (10분)
