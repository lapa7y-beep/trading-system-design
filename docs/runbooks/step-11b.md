...
KIS Paper Trading 환경에서 5 영업일 연속 실행. 합격기준 2~5번 동시 검증.

## 2. 합격 기준 매핑

- Phase 1 합격기준: 2, 3, 4, 5
- 기여 방식: 모의투자 5일 incident-free, P&L 자동기록, halt 검증, 크래시 복구
...
1. `docs/decisions/011-phase1-scope.md` — 합격 기준 섹션 전체 — 5개 기준 최종 확인 (10분)
