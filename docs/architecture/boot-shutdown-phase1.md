# boot-shutdown-phase1 — Boot / Shutdown 시퀀스

> **상태**: Phase 1 확정
> **최종 수정**: 2026-04-17
> **목적**: ATLAS 데몬의 기동·정상종료·긴급정지·크래시복구 절차를 단일 문서로 정의.
> **선행 문서**: `docs/architecture/cli-design.md`, `docs/architecture/fsm-design.md`, `docs/specs/config-schema-phase1.md`, `docs/specs/adapter-spec-phase1.md`
