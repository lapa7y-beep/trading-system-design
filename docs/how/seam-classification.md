# Port별 교체 난이도 분석 (Seam 4유형·6 Port 분류)

> **목적**: Feathers의 Seam 4유형을 ATLAS 6 Port에 적용하여 교체 난이도, 리스크, 테스트 전략을 분석한다.
> **층**: How

**기반 문헌**: Feathers, *Working Effectively with Legacy Code* (2004), Ch.4.
**SSoT**: `docs/what/specs/port-signatures-phase1.md`, `docs/what/specs/adapter-spec-phase1.md`
...
- `docs/how/seam-map.md` — Seam 위치 지도
