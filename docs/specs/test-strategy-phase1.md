...
> **선행 문서**: `docs/decisions/011-phase1-scope.md` (합격 기준), `docs/specs/project-structure-phase1.md` (tests/ 폴더 구조), `docs/specs/error-handling-phase1.md` (실패 시나리오)
...
`docs/decisions/011-phase1-scope.md`에서 정의된 **5개 합격 기준**을 자동화된 테스트로 검증.
